{{-- Layout principal de la aplicación, incluye la barra superior y el contenido --}}
<x-app-layout>
    {{-- Slot para el encabezado de la página --}}
    <x-slot name="header">
        <h2 class="font-bold text-3xl text-gray-900">Dashboard</h2> {{-- Título grande --}}
    </x-slot>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto space-y-8 px-6">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-10 border border-gray-200">
                ...
                {{-- Muestra el rol del usuario en color azul --}}
                ...
                {{-- Grid de 3 tarjetas con información del usuario --}}
                ...
                {{-- Botones de acceso rápido a paneles y gestión de sesiones --}}
                <div class="flex flex-wrap gap-6 pt-12 justify-center">
                    {{-- Botón para gestionar sesiones activas --}}
                    ...
                    {{-- Si el usuario es administrador, muestra el panel de admin --}}
                    ...
                    {{-- Si el usuario NO es admin, muestra el panel de cliente --}}
                    @if(!auth()->user()->isAdmin())
