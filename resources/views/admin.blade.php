{{-- Layout principal de la aplicación, incluye barra superior y contenido --}}
<x-app-layout>
    {{-- Slot para el encabezado de la página --}}
    <x-slot name="header">
        <h2 class="font-bold text-3xl text-gray-900">Panel de Administración</h2> {{-- Título grande --}}
    </x-slot>

    {{-- Contenedor principal con padding vertical --}}
    <div class="py-12">
        {{-- Contenedor centrado y espaciamiento entre elementos --}}
        <div class="max-w-6xl mx-auto space-y-8 px-6">
            {{-- Tarjeta principal con fondo degradado y sombra --}}
            <div class="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-3xl p-12 shadow-2xl">
                {{-- Icono de engranaje/ajustes para el panel admin --}}
                ...
                {{-- Título del panel administrador --}}
                ...
                {{-- Grid de 2 tarjetas para acciones administrativas --}}
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white border border-gray-200 rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300">
                        ...
                        {{-- Enlace para acceder a la gestión de usuarios --}}
                    ...
                    {{-- Tarjeta de reportes y logs --}}
                    <div class="bg-white border border-gray-200 rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:scale-[1.01] transition-all duration-300">
                        {{-- Icono de reportes/logs --}}
                        ...
                        {{-- Enlace para ver reportes y logs --}}
